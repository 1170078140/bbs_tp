...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="main">
  <tr>
    ...
    <span class="time"><strong>您好！<?php echo (session('userName')); ?></strong><u>[<?php echo (session('auth')); ?>]</u></span>
    <div class="top"><span class="left">您上次的登灵时间：<?php echo (session('lastlogin')); ?>   登录IP：127.0.0.1 &nbsp;&nbsp;&nbsp;&nbsp;如非您本人操作，请及时</span><a href="index.html" target="mainFrame" onFocus="this.blur()">更改密码</a></div>
    <div class="sec">论坛会员人数<span class="num">&nbsp;<?php echo (session('num')); ?>&nbsp;</span>个！</div>
    </td>
  </tr>
  <tr>
    ...
    会员注册：开启<br/>
会员投稿：开启<br/>
管理员个数：<font color="#538ec6"><strong><?php echo (session('sum')); ?></strong></font> 人<br/>
程序编码：UTF-8<br/>
    </div>
    </td>
    ...
    <div class="main-con">
服务器软件：Apache/2.4.18 (Win32) OpenSSL/1.0.2e PHP/7.0.6<br/>
PHP版本：7.0.6<br/>
MYSQL版本：mysqlnd 5.0.12<br/>
魔术引用：开启 (建议开启)<br/>
    </div>
    </td>
  </tr>
