...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：友情链接管理</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
  		  ...
  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="/index.php/Admin/Links/add" target="mainFrame" onFocus="this.blur()" class="add">新增友情链接</a></td>
  		</tr>
	</table>
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <?php if(is_array($linkRes)): foreach($linkRes as $key=>$v): ?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v['id']); ?></td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v['linkname']); ?></td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v['url']); ?></td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v['ctime']); ?></td>
        <!--<td align="center" valign="middle" class="borderright borderbottom">
          <input type="text" name="" value="<?php echo ($v['ordernum']); ?>" style="width: 30px;height: 24px;text-align: center;border: 1px solid #ccc;color: #8c8c8c;">
        </td>-->
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v['status']==1?'开启':'关闭'); ?></td>
        <td align="center" valign="middle" class="borderbottom">
          <a href="/index.php/Admin/Links/edit/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
          <a href="/index.php/Admin/Links/delete/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a>
        </td>
