...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：帖子管理</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <?php if(is_array($postRes)): foreach($postRes as $key=>$v): ?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom">
          <a href="/index.php/Admin/Post/detail/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">查看帖子</a><span class="gray">&nbsp;|&nbsp;</span>
          <a href="/index.php/Admin/Post/edit/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
          <?php if($v['elite'] == 1 ): ?><a href="/index.php/Admin/Post/cancelElite/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">取消加精</a><span class="gray">&nbsp;|&nbsp;</span>
           <?php else: ?>
            <a href="/index.php/Admin/Post/setElite/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">加精</a><span class="gray">&nbsp;|&nbsp;</span><?php endif; ?>

          <?php if($v['top'] == 1 ): ?><a href="/index.php/Admin/Post/cancelTop/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">取消置顶</a><span class="gray">&nbsp;|&nbsp;</span>
            <?php else: ?>
            <a href="/index.php/Admin/Post/setTop/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">置顶</a><span class="gray">&nbsp;|&nbsp;</span><?php endif; ?>

            <a href="/index.php/Admin/Post/reply/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">管理回复</a><span class="gray">&nbsp;|&nbsp;</span>
          <a href="/index.php/Admin/Post/toRecycle/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">放入回收站</a>
        </td>
