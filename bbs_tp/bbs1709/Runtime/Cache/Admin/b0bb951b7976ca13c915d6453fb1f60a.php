...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <form method="post" action="/php/case/6.1Project_bbs/index.php/Admin/User/updatePic/id/<?php echo ($userRes['id']); ?>" enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input type="text" name="userName" value="<?php echo ($userRes['username']); ?>" class="text-word" readonly style="color: #c6c6c6;">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">用户密码：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
          <img src="/php/case/6.1Project_bbs/Public/Photos/<?php echo ($photo); ?>" alt="" style="width: 200px;">
