...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
  		  ...
  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="/index.php/Admin/User/add" target="mainFrame" onFocus="this.blur()" class="add">新增管理员</a></td>
  		</tr>
	</table>
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">
          <img src="/Public/Photos/m_<?php echo ($v['photo']); ?>" alt="" style="margin: 7px 0;width: 100px;">
        </td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($role[$v['auth']]); ?></td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($status[$v['status']]); ?></td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v['lastlogin']); ?></td>
        <td align="center" valign="middle" class="borderbottom">
          <a href="/index.php/Admin/User/edit/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
          <a href="/index.php/Admin/User/editPic/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">更换头像</a><span class="gray">&nbsp;|&nbsp;</span>
          <a href="/index.php/Admin/User/delete/id/<?php echo ($v['id']); ?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a>
        </td>
