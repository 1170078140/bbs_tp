...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/Home/editor/styles/font-awesome.css">
    <link rel="stylesheet" type="text/css" href="/Public/Home/editor/styles/simditor.css">
    <link rel="stylesheet" type="text/css" href="/Public/Home/editor/styles/simditor-emoji.css">
...
<div class="main inner">
    <form method="post" action="/index.php/Home/Post/doPost">
    <table>
        ...
        <tr style="height: 50px;">
            <td colspan="3">标题：&nbsp;<input type="text" name="title" class="title" placeholder="请输入标题" required></td>
        </tr>
        <tr>
            <td colspan="3"><textarea id="editor" placeholder="这里输入内容" autofocus name='content' required></textarea></td>
        </tr>
        <tr style="height: 70px;">
            <td width="120"><input name="" type="submit" value="发布" class="btn"></td>
...
<script>
    var imgUrl='/Public/Home/editor/';
</script>

<script src="/Public/Home/editor/scripts/jquery.min.js"></script>
<script src="/Public/Home/editor/scripts/module.js"></script>
<script src="/Public/Home/editor/scripts/uploader.js"></script>
<script src="/Public/Home/editor/scripts/simditor.js"></script>
<script src="/Public/Home/editor/scripts/simditor-emoji.js"></script>
<script src="/Public/Home/editor/scripts/config.js"></script>
